...
function preload() 
{
    spaceFont = loadFont('/static/fonts/Anurati.otf');
    fontRegular = loadFont('/static/fonts/Helvetica.ttf');

    
    backgroundImage = loadImage('/static/images/background1.png'); // this image is the background while in "play" mode
    homeTrack = loadImage('/static/images/homeTrack.png'); // this is the track that appears on the home screen
    blueprint = loadImage('/static/images/blueprint2.png'); // this image is the background while in "build" mode

    // these are all the icons that the game will use. They are normal images. 
    icon = {
        redo: loadImage('/static/images/redo.png'), 
        star: loadImage('/static/images/star.png'), 
        starEmpty: loadImage('/static/images/starEmpty.png'), 
        delete: loadImage('/static/images/delete.png'), 
        circle: loadImage('/static/images/circle.png'), 
        back: loadImage('/static/images/back.png'), 
        edit: loadImage('/static/images/edit.png'), 
        help: loadImage('/static/images/help.png'), 
        lock: loadImage('/static/images/lock.png'), 
        play: loadImage('/static/images/play.png'),
        portal1: loadImage('/static/images/wormhole (2).png'), 
        portal2: loadImage('/static/images/wormhole (2).png'),
    };

    // these are all the images that the tracks will use split into the "play" and "build" versions of the tracks
    trackImages = [ 
        {play: loadImage('/static/images/tracks/lv1.png'), build: loadImage('/static/images/tracks/lv1build.png')},
        {play: loadImage('/static/images/tracks/lv2.png'), build: loadImage('/static/images/tracks/lv2build.png')},
        {play: loadImage('/static/images/tracks/lv3.png'), build: loadImage('/static/images/tracks/lv3build.png')},
        {play: loadImage('/static/images/tracks/lv4.png'), build: loadImage('/static/images/tracks/lv4build.png')},
        {play: loadImage('/static/images/tracks/lv5.png'), build: loadImage('/static/images/tracks/lv5build.png')},
        
        {play: loadImage('/static/images/tracks/lv7.png'), build: loadImage('/static/images/tracks/lv7build.png')},
        {play: loadImage('/static/images/tracks/lv8.png'), build: loadImage('/static/images/tracks/lv8build.png')},
        {play: loadImage('/static/images/tracks/lv9.png'), build: loadImage('/static/images/tracks/lv9build.png')},
        {play: loadImage('/static/images/tracks/lv10.png'), build: loadImage('/static/images/tracks/lv10build.png')},
        {play: loadImage('/static/images/tracks/lv11.png'), build: loadImage('/static/images/tracks/lv11build.png')},
        
        {play: loadImage('/static/images/tracks/lv6.png'), build: loadImage('/static/images/tracks/lv6build.png')},
        
        {play: loadImage('/static/images/tracks/lv3.png'),  build: loadImage('/static/images/tracks/lv3build.png')},
        {play: loadImage('/static/images/tracks/lv13.png'), build: loadImage('/static/images/tracks/lv13build.png')},
        {play: loadImage('/static/images/tracks/lv14.png'), build: loadImage('/static/images/tracks/lv14build.png')},
        {play: loadImage('/static/images/tracks/lv15.png'), build: loadImage('/static/images/tracks/lv15build.png')},

    ]

    // these are all the images that are used in popups 
    popUpImage = {
        portal: loadImage('/static/images/popups/popup (1).png'), 
        toggle: loadImage('/static/images/popups/toggle.png'), 
        multipleTestCharges: loadImage('/static/images/popups/popup (2).png'), 
        gameMode: loadImage('/static/images/popups/popup (3).png'), 
        slider: loadImage('/static/images/popups/popup (4).png'), 
        eField: loadImage('/static/images/popups/popup (5).png'), 
        track: loadImage('/static/images/popups/popup (6).png'), 
        negative: loadImage('/static/images/popups/popup (7).png'), 
    ...
    sounds = {
        click: loadSound('/static/sounds/click (1).mp3'),
        lose: loadSound('/static/sounds/hit.mp3'),
        collect: loadSound('/static/sounds/collect.mp3'),
        victory: loadSound('/static/sounds/victory.mp3'),
        portal: loadSound('/static/sounds/portal.mp3'),
        // click: loadSound('/static/sounds/clickv2.mp3'),
        // lose: loadSound('/static/sounds/failv2.mp3'),
        // collect: loadSound('/static/sounds/starv2.mp3'),
        //victory: loadSound('/static/sounds/successv2.mp3'),
        popup: loadSound('/static/sounds/popupv2.mp3'),
        };
