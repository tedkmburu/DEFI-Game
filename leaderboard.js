...
async function setup()    // This function only runs once when the page first loads. 
{
    ...
    setInterval(function(){ updateLeaderBoard(); console.log("updated data"); }, 5000);
    ...
    navigateTo("Leaderboard"); // this navigates to the first screen the users will see when he game is first opened. The screen the user first sees can be set in the variables.js file
