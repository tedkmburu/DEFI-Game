...
async function setup()    // This function only runs once when the page first loads. 
{
    ...
    navigateTo("Coming Soon"); // this navigates to the first screen the users will see when he game is first opened. The screen the user first sees can be set in the variables.js file
