...
function createScreens() 
{
    screens = [
        ...
        new Screen({
            ...
            visibility: "hidden", 
            buttons: [
                new Button({x: 15 , y: 10 , width: 30 , height: 30, title: "<"              , onClick: function()
                {
                    navigateBack(); 
                    // updateLeaderBoard(); 
                }, shape: "Back", bgColor: "white"             , fontColor: "black", fontSize: 14}), 
        ...
        new Screen({
            ...
            textBoxes: [
                ...
                new TextBox({x: 406, y: 112, class: textClass.credits, text: "Anonymous"}),
        ...
        new Screen({
            ...
            buttons: [
                ...
                new Button({x: 552, y: 15, width:  30, height: 25, title: "<" , onClick: function()
                {
                    decreaseLeaderboardLevel(); 
                    // updateLeaderBoard(); 
                }, shape: "Rect", bgColor: chargeColor.positive, fontColor: "white", fontSize: 14}),
                new Button({x: 652, y: 15, width:  30, height: 25, title: ">" , onClick: function()
                { 
                    increaseLeaderboardLevel(); 
                    // updateLeaderBoard(); 
                }, shape: "Rect", bgColor: chargeColor.positive, fontColor: "white", fontSize: 14})
                ],
            textBoxes: [],
        ...
        new Screen({
            ...
            textBoxes: [
                new TextBox({x: 250, y: 187.5, id: "hint1", text: "The leaderboard is disabled \n for this version on the game", font: fontRegular, fontSize: 24, color: "white", visibility: "visible", align: LEFT}), 
