    ...
    screens = [
        ...
        new Screen({
            ...
            textBoxes: [
                ...
                new TextBox({x: 406, y: 160, class: textClass.credits, text: "Vivek Kumar"}),
                new TextBox({x: 406, y: 172, class: textClass.credits, text: "Ted Mburu"}),
                new TextBox({x: 406, y: 184, class: textClass.credits, text: "Eli Robinson"}),
